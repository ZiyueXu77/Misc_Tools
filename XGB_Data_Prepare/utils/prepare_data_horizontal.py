...
def main():
    ...
    # split row
    site_row_size = split_num_proportion(int(rows_total), args.site_num)
    ...
    for site in range(args.site_num):
        ...
        df_split = df.iloc[row_start:row_end, :]
        ...
        if args.target_app == 0:
            ...
            # Add Header for FATE, first column is y, following features are x1, x2, ...
            df_split.columns = ["y"] + [f"x{i}" for i in range(1, cols_total)]
